...
int do_answer(string arg)
{
        ...
        int soln,riddle;
        me = this_player();
        riddle=query_temp("marks/谜", this_player());
...
//          say("阿凡提给了" + me->name() + "一两黄金。\n");
          set_temp("marks/谜", 0, this_player());
