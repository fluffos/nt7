...
mapping *action = ({
// ZHAOSHI : 0
([      "action" : "$N伸出右手，中指竖起，一式「断天」，死死的顶住$n的.....",
	"attack" : 260,
	"damage" : 260,
	"force" : 260,
	"dodge" : 260,
...
int valid_learn(object me)
{
        if( query_temp("weapon", me) || query_temp("secondary_weapon", me) )
                return notify_fail("练"+"无影指"+"必须空手。\n");
        if( query("max_neili", me)<50 )
                return notify_fail("你的内力太弱，无法练"+"无影指"+"。\n");
        return 1;
}
...
{
	return
 "无影指是创自李白的绝世指法，招式勇往直前，大开大阖，以勇猛霸;道而
著称，当初江湖十大掌门围攻李白的时候，情势万分危机，李白在千;钧一
